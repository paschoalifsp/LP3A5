...
public class Pessoa {
	String id; String nome; String nacionalidade; int idade;
	...
	public List<Pessoa> populaPessoas(){
		...
		list.add(pessoa1); list.add(pessoa2); list.add(pessoa3); list.add(pessoa4);
		return list;
	}
	@Override
	public String toString() { return this.nome; } //acrescentar gets e sets
	public String getId() {
		return id;
	}
